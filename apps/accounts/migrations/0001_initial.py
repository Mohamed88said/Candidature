    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('candidate', 'Candidat'), ('admin', 'AdministratGNF'), ('hr', 'Ressources Humaines')], default='candidate', max_length=20)),
            ...
            options={
                'verbose_name': 'UtilisatGNF',
                'verbose_name_plural': 'UtilisatGNFs',
            },
            managers=[
