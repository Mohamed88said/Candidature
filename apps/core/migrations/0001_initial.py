...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('page_type', models.CharField(choices=[('about', 'À propos'), ('privacy', 'Politique de confidentialité'), ('terms', "Conditions d'utilisation"), ('faq', 'FAQ'), ('contact', 'Contact'), ('home', 'Accueil'), ('custom', 'Page personnalisée')], max_length=20, unique=True)),
