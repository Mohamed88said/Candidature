...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@recruitment-platform.com')
...
ALLOWED_FILE_TYPES = config('ALLOWED_FILE_TYPES', default='pdf,doc,docx,txt').split(',')
